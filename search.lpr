...
(define-project :name :search
  :modules (list (make-instance 'module :name "route-finding.lisp")
                 (make-instance 'module :name "problems.lisp")
                 (make-instance 'module :name "simple.lisp")
                 (make-instance 'module :name "repeated.lisp")
                 (make-instance 'module :name "iterative.lisp")
                 (make-instance 'module :name "csp.lisp")
                 (make-instance 'module :name "ida.lisp"))
  :projects nil
  :libraries nil
  :editable-files nil
